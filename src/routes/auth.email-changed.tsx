...
export const Route = createFileRoute("/auth/email-changed")({
  head: () => ({
    meta: [
      { title: "Email changed — ScholarX" },
    ...
    <main className="relative flex min-h-screen items-center justify-center px-4 py-10">
      <div className="w-full max-w-md text-center">
        ...
        <div className="glass rounded-2xl p-8 shadow-[var(--shadow-card)] mt-4">
          ...
          <h1 className="font-display text-2xl font-bold">Email address updated</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Your email address has been successfully changed. Use your new
            address the next time you sign in.
          </p>
