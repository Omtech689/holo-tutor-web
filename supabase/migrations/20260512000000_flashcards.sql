...
CREATE INDEX flashcard_decks_user_idx ON public.flashcard_decks(user_id, created_at DESC);
...
CREATE INDEX flashcards_deck_idx ON public.flashcards(deck_id, created_at);
